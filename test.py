...
def get_faculty_valid_pairs(prof_slots):
    valid_pairs = {}
    ...
    for prof, slots in prof_slots.items():
        ...
        valid_pairs[prof] = final_combinations
...
# Collecting slots for each professor
...
valid_pairs = get_faculty_valid_pairs(prof_slots)

# Output the results
for prof, pairs in valid_pairs.items():
